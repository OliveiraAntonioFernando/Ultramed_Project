...
urlpatterns = [
    ...
    path('master/licenca/processar/', views.processar_pagamento_licenca, name='licenca_processar'),
    path('master/licenca/status/', views.consultar_status_licenca, name='licenca_status'),
